...
<img class="rounded-circle header-profile-user" src="{{ (!empty($user->profile_photo_path))? url('upload/admin_images/'.$user->profile_photo_path):url('upload/no_image.jpg') }}" width="50px" height="50px" />
